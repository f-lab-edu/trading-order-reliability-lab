...
@ConfigurationProperties(prefix = "gateway.messaging.outbox")
public class GatewayOutboxPublisherProperties {
    ...
    public Duration nextRetryDelay(int retryCount) {
        double multiplier = Math.pow(retryBackoffMultiplier, Math.max(retryCount - 1, 0));
